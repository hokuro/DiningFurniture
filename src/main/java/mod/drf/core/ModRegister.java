...
public class ModRegister {
	...
	public static void RegisterItem(FMLPreInitializationEvent event){
        ...
        if (event.getSide().isClient()) {
        	...
        	for (String key : foodResource.keySet()){
	...
	public static void RegisterRecipe(){
		...
		// 調理台
		GameRegistry.addShapedRecipe(new ResourceLocation(ModCommon.MOD_ID + ":" + "Dining"),
				new ResourceLocation(ModCommon.MOD_ID + ":" + "Furniture"),
		...
		// 砂糖入り牛乳
		GameRegistry.addShapelessRecipe(new ResourceLocation(ModCommon.MOD_ID + ":" + "Dining"),
				new ResourceLocation(ModCommon.MOD_ID + ":" + "Foods"),
