...
import mod.drf.foods.inventory.InventoryOriginalMenu;
...
public class GuiOriginalWorkBench extends GuiContainer {
    ...
    private static final ResourceLocation tex = new ResourceLocation("drf:textures/gui/container/originalworkbench.png");
    ...
    {
        String s = net.minecraft.util.text.translation.I18n.translateToLocal("cooking workbench");
