...
public class ItemFurniture {
	...
	public static Item item_zabuton_white = new ItemZabuton(NAME_ZABUTON_WHITE, EnumDyeColor.WHITE, new Item.Properties().group(Mod_DiningFurniture.tabFurniture).maxStackSize(16)).setRegistryName(NAME_ZABUTON_WHITE);
	public static Item item_zabuton_orange = new ItemZabuton(NAME_ZABUTON_ORANGE,EnumDyeColor.ORANGE,new Item.Properties().group(Mod_DiningFurniture.tabFurniture).maxStackSize(16)).setRegistryName(NAME_ZABUTON_ORANGE);
	public static Item item_zabuton_magenta = new ItemZabuton(NAME_ZABUTON_MAGENTA,EnumDyeColor.MAGENTA,new Item.Properties().group(Mod_DiningFurniture.tabFurniture).maxStackSize(16)).setRegistryName(NAME_ZABUTON_MAGENTA);
	public static Item item_zabuton_light_blue = new ItemZabuton(NAME_ZABUTON_LIGHT_BLUE,EnumDyeColor.LIGHT_BLUE,new Item.Properties().group(Mod_DiningFurniture.tabFurniture).maxStackSize(16)).setRegistryName(NAME_ZABUTON_LIGHT_BLUE);
	public static Item item_zabuton_yellow = new ItemZabuton(NAME_ZABUTON_YELLOW,EnumDyeColor.YELLOW,new Item.Properties().group(Mod_DiningFurniture.tabFurniture).maxStackSize(16)).setRegistryName(NAME_ZABUTON_YELLOW);
	public static Item item_zabuton_lime = new ItemZabuton(NAME_ZABUTON_LIME,EnumDyeColor.LIME,new Item.Properties().group(Mod_DiningFurniture.tabFurniture).maxStackSize(16)).setRegistryName(NAME_ZABUTON_LIME);
	public static Item item_zabuton_pink = new ItemZabuton(NAME_ZABUTON_PINK,EnumDyeColor.PINK,new Item.Properties().group(Mod_DiningFurniture.tabFurniture).maxStackSize(16)).setRegistryName(NAME_ZABUTON_PINK);
	public static Item item_zabuton_gray = new ItemZabuton(NAME_ZABUTON_GRAY,EnumDyeColor.GRAY,new Item.Properties().group(Mod_DiningFurniture.tabFurniture).maxStackSize(16)).setRegistryName(NAME_ZABUTON_GRAY);
	public static Item item_zabuton_silver = new ItemZabuton(NAME_ZABUTON_SILVER,EnumDyeColor.LIGHT_GRAY,new Item.Properties().group(Mod_DiningFurniture.tabFurniture).maxStackSize(16)).setRegistryName(NAME_ZABUTON_SILVER);
	public static Item item_zabuton_cyan = new ItemZabuton(NAME_ZABUTON_CYAN,EnumDyeColor.CYAN,new Item.Properties().group(Mod_DiningFurniture.tabFurniture).maxStackSize(16)).setRegistryName(NAME_ZABUTON_CYAN);
	public static Item item_zabuton_purple = new ItemZabuton(NAME_ZABUTON_PURPLE,EnumDyeColor.PURPLE,new Item.Properties().group(Mod_DiningFurniture.tabFurniture).maxStackSize(16)).setRegistryName(NAME_ZABUTON_PURPLE);
	public static Item item_zabuton_blue = new ItemZabuton(NAME_ZABUTON_BLUE,EnumDyeColor.BLUE,new Item.Properties().group(Mod_DiningFurniture.tabFurniture).maxStackSize(16)).setRegistryName(NAME_ZABUTON_BLUE);
	public static Item item_zabuton_brown = new ItemZabuton(NAME_ZABUTON_BROWN,EnumDyeColor.BROWN,new Item.Properties().group(Mod_DiningFurniture.tabFurniture).maxStackSize(16)).setRegistryName(NAME_ZABUTON_BROWN);
	public static Item item_zabuton_green = new ItemZabuton(NAME_ZABUTON_GREEN,EnumDyeColor.GREEN,new Item.Properties().group(Mod_DiningFurniture.tabFurniture).maxStackSize(16)).setRegistryName(NAME_ZABUTON_GREEN);
	public static Item item_zabuton_red = new ItemZabuton(NAME_ZABUTON_RED,EnumDyeColor.RED,new Item.Properties().group(Mod_DiningFurniture.tabFurniture).maxStackSize(16)).setRegistryName(NAME_ZABUTON_RED);
	public static Item item_zabuton_black = new ItemZabuton(NAME_ZABUTON_BLACK,EnumDyeColor.BLACK,new Item.Properties().group(Mod_DiningFurniture.tabFurniture).maxStackSize(16)).setRegistryName(NAME_ZABUTON_BLACK);
