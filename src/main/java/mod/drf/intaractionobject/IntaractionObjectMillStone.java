...
public class IntaractionObjectMillStone implements IInteractionObject {

	private BlockPos entPos;

	public IntaractionObjectMillStone(BlockPos blockPos) {
	...
	public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn) {
		...
		if (ent instanceof TileEntityMillStone){
			return new ContainerMillStone(playerIn.inventory, (IInventory)ent);
		}
		return null;
	}
	...
	public String getGuiID() {
		// TODO 自動生成されたメソッド・スタブ
		return ModCommon.MOD_ID + ":" + ModCommon.MOD_GUI_ID_MILLSTONE;
	}
}